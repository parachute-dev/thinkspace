 ...
 * https://modernizr.com/download/?-canvas-eventlistener-flash-flexbox-flexboxlegacy-fullscreen-geolocation-inlinesvg-input-mediaqueries-pointermq-search-svg-video-setclasses-shiv !*/
 ! function(e, t, n) {
    function r(e, t) {
        return typeof e === t
    }
    ...
    function u(e, n, r, o) {
        var i, l, c, u, f = "modernizr",
            d = a("div"),
            p = s();
        if (parseInt(r, 10))
            for (; r--;) c = a("div"), c.id = o ? o[r] : f + (r + 1), d.appendChild(c);
        return i = a("style"), i.type = "text/css", i.id = "s" + f, (p.fake ? p : d).appendChild(i), p.appendChild(d), i.styleSheet ? i.styleSheet.cssText = e : i.appendChild(t.createTextNode(e)), d.id = f, p.fake && (p.style.background = "", p.style.overflow = "hidden", u = x.style.overflow, x.style.overflow = "hidden", x.appendChild(p)), l = n(d, e), p.fake ? (p.parentNode.removeChild(p), x.style.overflow = u, x.offsetHeight) : d.parentNode.removeChild(d), !!l
    }
    ...
    function g(e, t, o, i) {
        ...
        for (var u, d, p, m, v, g = ["modernizr", "tspan", "samp"]; !q.style && g.length;) u = !0, q.modElem = a(g.shift()), q.style = q.modElem.style;
        for (p = e.length, d = 0; p > d; d++)
            if (m = e[d], v = q.style[m], f(m, "-") && (m = c(m)), q.style[m] !== n) {
                if (i || r(o, "undefined")) return s(), "pfx" == t ? m : !0;
                try {
                    q.style[m] = o
                } catch (y) {}
                if (q.style[m] != v) return s(), "pfx" == t ? m : !0
            }
        return s(), !1
    }
    ...
    var b = [],
        ...
        Modernizr = function() {};
    Modernizr.prototype = S, Modernizr = new Modernizr, Modernizr.addTest("eventlistener", "addEventListener" in e), Modernizr.addTest("geolocation", "geolocation" in navigator), Modernizr.addTest("svg", !!t.createElementNS && !!t.createElementNS("http://www.w3.org/2000/svg", "svg").createSVGRect);
    ...
    Modernizr.input = function(t) {
        for (var n = 0, r = t.length; r > n; n++) k[t[n]] = !!(t[n] in T);
        return k.list && (k.list = !(!a("datalist") || !e.HTMLDataListElement)), k
    }(_);
    var N = function() {
        function e(e, t) {
            var o;
    ...
    S.hasEvent = N, Modernizr.addTest("inputsearchevent", N("search"));
    var P;
    ! function() {
        ...
        var n, r, o = function(e) {
            ...
            c = function(e, t) {
                var n = !!e;
                if (n && (n = new Boolean(n), n.blocked = "blocked" === e), l("flash", function() {
                        return n
                    }), t && m.contains(t)) {
        ...
        if (n = !("plugins" in navigator && "Shockwave Flash" in navigator.plugins || r), n || E) c(!1);
        else {
            var f, d, p = a("embed"),
                m = s();
            if (p.type = "application/x-shockwave-flash", m.appendChild(p), !("Pan" in p || r)) return o(m), c("blocked", p), void i(m);
            f = function() {
                return o(m), x.contains(m) ? (x.contains(p) ? (d = p.style.cssText, "" !== d ? c("blocked", p) : c(!0, p)) : c("blocked"), void i(m)) : (m = t.body || m, p = a("embed"), p.type = "application/x-shockwave-flash", m.appendChild(p), setTimeout(f, 1e3))
            }, setTimeout(f, 10)
        }
    });
    var j = function() {
    ...
    S.mq = j, Modernizr.addTest("mediaqueries", j("only all")), Modernizr.addTest("pointermq", j("(pointer:coarse),(pointer:fine),(pointer:none)"));
    var F = "Moz O ms Webkit",
        L = S._config.usePrefixes ? F.split(" ") : [];
    S._cssomPrefixes = L;
    var z = function(t) {
    ...
    S.atRule = z;
    var M = S._config.usePrefixes ? F.toLowerCase().split(" ") : [];
    S._domPrefixes = M;
    var A = {
        elem: a("modernizr")
    };
    ...
    var O = S.prefixed = function(e, t, n) {
        return 0 === e.indexOf("@") ? z(e) : (-1 != e.indexOf("-") && (e = c(e)), t ? y(e, t, n) : y(e, "pfx"))
    };
    Modernizr.addTest("fullscreen", !(!O("exitFullscreen", t, !1) && !O("cancelFullScreen", t, !1))), S.testAllProps = C, Modernizr.addTest("flexbox", C("flexBasis", "1px", !0)), Modernizr.addTest("flexboxlegacy", C("boxDirection", "reverse", !0)), o(), i(b), delete S.addTest, delete S.addAsyncTest;
