	...
	// If there is more than 1 image attachment in a gallery
		...
		<p><a href="<?php echo $next_attachment_url; ?>" title="<?php echo esc_attr( get_the_title() ); ?>" rel="attachment"><?php
			$attachment_size = apply_filters( 'twentyten_attachment_size', 900 );
					...
					<?php while(has_sub_field('team_selector')) {; ?>

					<div class="team">
						<h2><?php the_sub_field('team_name'); ?></h2>

						<?php  $posts = get_sub_field('team');
						...
						<?php foreach( $posts as $post): ?>
							...
							<a href="<?php echo get_permalink(); ?>" > 								
								<?php if (has_post_thumbnail( $post->ID ) ): ?>
									...
									<img src="<?php bloginfo('template_url'); ?>/php/resize.php?src=<?php echo $image[0]; ?>&amp;w=300px&amp;h=300&amp;zc=1" alt="" />
								<?php endif; ?>		
